...
def main():
    ...
    parser.add_argument('--color_completion', type=str, default="#2166AC,#B2182B", help='Comma-separated colors for completion rate')
    parser.add_argument('--color_n_speciation', type=str, default="#2166AC,#B2182B", help='Comma-separated colors for number of speciation events')
    parser.add_argument('--color_birth', type=str, default="#2166AC,#B2182B", help='Comma-separated colors for birth rates')
    parser.add_argument('--color_death', type=str, default="#2166AC,#B2182B", help='Comma-separated colors for death rates')
    parser.add_argument('--color_net', type=str, default="#2166AC,#B2182B", help='Comma-separated colors for net diversification')
    parser.add_argument('--color_transition', type=str, default="#E08214,#2D004B", help='Comma-separated colors for transitions')
    ...
    parser.add_argument('--anc_state_colors', type=str, default="#542788,#2D004B,#FDB863,#E08214", help='Comma-separated colors for ancestral states')
