...
def parse_arguments():
    ...
    parser.add_argument("-spt", "--speciation_events_tree", required=True, help="Path to tree with speciation events (Nexus format)")
...
def main():
    ...
    args.speciation_events_tree   = os.path.abspath(args.speciation_events_tree)
    ...
    # Read the trees
    sp_events_tree = read_tree(args.speciation_events_tree)

    # Clone and transform the protracted tree
    conspec_prob_tree = clone_tree(sp_events_tree)
